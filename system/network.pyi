...
class Server:
    ...
    async def start(self, host: str, port: int, ws_port: Optional[int] = None, *args: Any, **kwargs: Any) -> None: ...
...
class Client:
    ...
    def __init__(self: Self, ws_port: Optional[int] = None, ws_scheme: str = "ws") -> None: ...
